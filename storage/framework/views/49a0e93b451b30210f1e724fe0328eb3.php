<?php $__env->startSection('title', 'Tambah Pakaian'); ?>
...
<div class="row justify-content-center">
    <div class="col-lg-9">
        <div class="soft-card">
            ...
            <div class="p-4">
                <form method="POST" action="<?php echo e(route('clothes.store')); ?>" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Dressory\resources\views/clothes/create.blade.php ENDPATH**/ ?>