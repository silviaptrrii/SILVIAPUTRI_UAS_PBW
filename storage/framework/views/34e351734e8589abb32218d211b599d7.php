        ...
        <div class="soft-card p-4 p-md-5">
            ...
            <form method="POST" action="<?php echo e(route('register')); ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" class="form-control" value="<?php echo e(old('name')); ?>" placeholder="Masukkan nama" required autofocus>
                </div>
                <div class="mb-3">
            ...
            <p class="text-center mt-4 mb-0 text-muted">Sudah punya akun? <a class="fw-semibold" href="<?php echo e(route('login')); ?>">Login</a></p>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\Dressory\resources\views/auth/register.blade.php ENDPATH**/ ?>