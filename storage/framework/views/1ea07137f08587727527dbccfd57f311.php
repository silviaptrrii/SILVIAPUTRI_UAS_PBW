...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Wardrobe & Outfit Planner'); ?></title>
...
<?php if(auth()->guard()->check()): ?>
    <div class="app-shell">
        <aside class="sidebar">
            <a class="brand-wrap" href="<?php echo e(auth()->user()->role === 'admin' ? route('admin.dashboard') : route('dashboard')); ?>">
            ...
            <nav>
                <?php if(auth()->user()->role === 'user'): ?>
                    <a class="side-link <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?>" href="<?php echo e(route('dashboard')); ?>">
                        <i class="bi bi-house-heart"></i> Dashboard
                    </a>
                    <a class="side-link <?php echo e(request()->routeIs('categories.*') ? 'active' : ''); ?>" href="<?php echo e(route('categories.index')); ?>">
                        <i class="bi bi-tags"></i> Kategori
                    </a>
                    <a class="side-link <?php echo e(request()->routeIs('clothes.*') ? 'active' : ''); ?>" href="<?php echo e(route('clothes.index')); ?>">
                        <i class="bi bi-bag-heart"></i> Wardrobe
                    </a>
                    <a class="side-link <?php echo e(request()->routeIs('outfits.*') ? 'active' : ''); ?>" href="<?php echo e(route('outfits.index')); ?>">
                        <i class="bi bi-calendar-heart"></i> Outfit Planner
                    </a>
                <?php else: ?>
                    <a class="side-link <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>" href="<?php echo e(route('admin.dashboard')); ?>">
        ...
        <main class="main-panel">
            <div class="mobile-topbar">
                <nav class="navbar navbar-expand-lg soft-card px-3 py-2">
                    <a class="navbar-brand fw-bold text-brand" href="<?php echo e(auth()->user()->role === 'admin' ? route('admin.dashboard') : route('dashboard')); ?>">
                    ...
                    <div class="collapse navbar-collapse" id="mobileNav">
                        <ul class="navbar-nav ms-auto">
                            <?php if(auth()->user()->role === 'user'): ?>
                                ...
                                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('clothes.index')); ?>">Pakaian</a></li>
                                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('outfits.index')); ?>">Outfit</a></li>
                            <?php else: ?>
            ...
            <div class="topbar d-flex align-items-center justify-content-between gap-3">
                <div>
                    ...
                    <div class="fw-bold text-brand"><i class="bi bi-person-heart text-rose me-1"></i><?php echo e(auth()->user()->name); ?></div>
                </div>
...
<?php /**PATH C:\laragon\www\Dressory\resources\views/layouts/app.blade.php ENDPATH**/ ?>